...
>
> **升级提醒**：插件仍在快速迭代，建议与 App 同步更新；使用 DSH 0.1.2-alpha.1 时，请将两者升级至 0.3.2 或更高版本。[兼容说明](#兼容性)。
...
0.3.4 插件兼容现有 0.3.3 App，无需重新配对。旧 App 的状态栏策略不适配新版 Web，请按上方提示同步升级；App 0.1.3 及更早版本需卸载重装并重新配对。
